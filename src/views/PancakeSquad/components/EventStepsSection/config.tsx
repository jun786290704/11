  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active PCMSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold PCM'),
      bodyText: [t('Each NFT costs PCM to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://pancakeswap.finance/swap?outputCurrency=0xf35Ef2945344308bF92283CD230Cf9CD5277C492"
            target="_blank"
            width="100%"
          >
            {t('Buy PCM')}
